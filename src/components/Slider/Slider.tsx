    ...
    return (
        <Container>
            ...
            >
                ...
                <div>
                    <div style={{ backgroundImage: `url(${croke})` }} className='slider-content-main'>
                        <Row className='row-title' style={{ backgroundColor: "#136833", padding: "8px", color: "white" }}>Croke Park Muslim Eid</Row>
                        <Row>
                            <Button style={{
                                marginTop: "10px",
                                backgroundColor: "#136833",
                                ...
                                onClick={() => window.open('https://www.irishtimes.com/ireland/2022/07/09/eid-celebrations-at-croke-park-we-can-celebrate-our-irish-muslim-identity-in-the-most-iconic-irish-venue/', '_blank')}>Go News</Button>
                        </Row>
                    ...
                    <div style={{ backgroundImage: `url(${dscie})` }} className='slider-content-main'>
                        ...
                        <Row>
                            <Button style={{
                                ...
                                onClick={() => window.open('https://www.discoverireland.ie/', '_blank')}>Discover Ireland</Button>
                        </Row>
                    </div>
                </div>
                ...
                <div>
                    <div style={{ backgroundImage: `url(${marr})` }} className='slider-content-main'>
                        ...
                        <Row className='row-content-main'>For details of the Nikah process at the Sultan Mecid Masjid, Dublin, including how to apply. +353 (87) 406 6894.</Row>
                    </div>
                </div>
